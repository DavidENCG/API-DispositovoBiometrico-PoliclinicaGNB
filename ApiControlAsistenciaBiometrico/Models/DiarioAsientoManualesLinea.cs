...
public partial class DiarioAsientoManualesLinea
{
    public int Id { get; set; }

    public int IdDiarioAsiento { get; set; }
    ...
    public virtual DiarioAsientoManualesCabecera IdDiarioAsientoNavigation { get; set; } = null!;
